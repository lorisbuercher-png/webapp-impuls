export default function AdminLayout({ children }: { children: React.ReactNode }) {
  const menu = [
    ...
    ["👥", "Kandidaten", "/admin/kandidaten"],
    ["📄", "Dokumente", "/admin/dokumente"],
    ["💰", "Lohn", "/admin/lohn"],
    ["⚠️", "Bewilligungen", "/admin/bewilligungen"],
    ["📤", "Rapporte", "/admin/rapporte"],
  ...
  return (
    <main className="flex min-h-screen bg-[#F7F8FC] text-[#1F2937]">
      ...
      <section className="flex min-h-screen min-w-0 flex-1 flex-col">
        <header className="flex items-center justify-between border-b border-gray-200 bg-white px-5 py-5 md:px-8"><div><p className="text-sm text-gray-500">IMPULS Swiss</p><h1 className="text-xl font-bold">Adminbereich</h1></div><div className="rounded-full bg-[#6D5DF6] px-4 py-2 text-sm font-semibold text-white">Admin</div></header>
